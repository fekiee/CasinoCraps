...
* required to program the game in computer source-code.
*
...
*IMPORTANT: CCT holds no liability for any losses incurred should you choose to gamble real money 
*in any way.  We highly recommend that you do NOT gamble real money, in any way, as you will most 
*likely lose it.
*
*/
class Craps
